...
// File Explanation
// This file is used to calculate the tax of the user and display the tax to be paid by the user
// It takes the input from the user and then sends it to the server to calculate the tax
// The calculated tax is then displayed to the user
// It sends to the server with the help of the TaxApi file
// It uses the Tax model to display the tax to be paid by the user
